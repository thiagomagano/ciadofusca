...
export const actions = {
  default: async ({ request, locals, params }) => {
    ...
    if (!nome) { return fail(400, { missingName: true, msg: 'O campo Nome é obrigatórios' }); }
    if (!whatsapp) { return fail(400, { missingWpp: true, msg: 'O campo Whatsapp obrigatórios' }); }
    if (!whatsapp.match(whatsappRegex)) { return fail(400, { incorrect: true, msg: "O numéro deve estar em um formato válido ex: 51987654321" }); }
